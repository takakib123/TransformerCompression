...
class CompressedLlavaDecoderLayer(LlamaDecoderLayer):
    """
...
class LlavaLayerAdapter(LayerAdapter):
...
class LlavaModelAdapter(ModelAdapter):
    ...
    def layer_adapter_type(self) -> type:
        return LlavaLayerAdapter

    @property
    def compressed_layer_type(self) -> type:
        return CompressedLlavaDecoderLayer
